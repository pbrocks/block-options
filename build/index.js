...
function registerBlocks() {
  [_blocks_import__WEBPACK_IMPORTED_MODULE_26__].forEach(function (block) {
    ...
    registerBlockType("sidetrack/".concat(name), _objectSpread({
      category: 'common'
    }, settings));
  });
}
...
var title = __('Import', 'blockshop-options');

var keywords = [__('import', 'blockshop-options'), __('download', 'blockshop-options'), __('migrate', 'blockshop-options')];
var blockAttributes = {
  file: {
    type: 'object'
  }
...
var enhance = compose(withDispatch(function (dispatch) {
  ...
  return {
    editorsKitDisableBlock: function editorsKitDisableBlock(blockName, clientId) {
      ...
      createNotice('info', blockTitle + __(' block has been disabled.', 'blockshop-options'), {
        isDismissible: true,
        type: 'snackbar'
      });
    }
...
var withInspectorControl = createHigherOrderComponent(function (BlockEdit) {
  return enhance(function (_ref) {
    ...
    var sidetrack = attributes.sidetrack;
    ...
    if (typeof sidetrack !== 'undefined' && typeof sidetrack.unit_test !== 'undefined' && sidetrack.unit_test && props.isSelected) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(BlockEdit, props), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(InspectorAdvancedControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
        className: "components-base-control components-button-control components-sidetrack-disable-block"
      ...
      }, __('Remove & Disable Block', 'blockshop-options'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("p", {
...
addFilter('editor.BlockEdit', 'sidetrack/advanced/disable-block', withInspectorControl);
...
var hasBlockSupport = wp.blocks.hasBlockSupport;
var restrictedBlocks = ['core/block', 'core/freeform', 'core/shortcode', 'core/template', 'core/nextpage', 'sidetrack/import'];
...
var withAdvancedControls = createHigherOrderComponent(function (BlockEdit) {
  return enhance(function (_ref) {
    ...
    if (typeof sidetrack !== 'undefined' && !sidetrack.migrated && blockOpts) {
      ...
      var newClassNames = props.attributes.className.replace('b' + blockOpts.id, '').replace('wpblockshop-show', '').replace('wpblockshop-hide', '').replace('wpblockshop-desktop', '').replace('wpblockshop-tablet', '').replace('wpblockshop-mobile', '');
      newClassNames = newClassNames.trim();
      props.attributes.className = newClassNames;
      setAttributes({
        sidetrack: props.attributes.sidetrack,
    ...
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("small", null, __('Attention: The display settings (show/hide for mobile, tablet or desktop) will only take effect once you are on the live page, and not while you\'re editing in Gutenberg.', 'blockshop-options')), Object(_options_devices___WEBPACK_IMPORTED_MODULE_3__["default"])(props))), isSelected && !restrictedBlocks.includes(name) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(InspectorAdvancedControls, null, !isDisabledUserState && Object(_options_state___WEBPACK_IMPORTED_MODULE_4__["default"])(props)));
  });
}, 'withAdvancedControls');
addFilter('editor.BlockEdit', 'sidetrack/advanced', withAdvancedControls);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ACFOptions, [{
    ...
    value: function render() {
      ...
      var onSelectFields = function onSelectFields(key, value) {
        ...
        var blockOptions = Object.assign(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, key, value), sidetrack);
        dispatch('core/block-editor').updateBlockAttributes(clientId, {
          sidetrack: blockOptions
        });
      ...
      if (typeof acf !== 'undefined') {
        if (!Object(lodash__WEBPACK_IMPORTED_MODULE_7__["isEmpty"])(acf)) {
          ...
          return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
            className: "sidetrack-button-group-container sidetrack-button-group-acf"
          }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("label", {
            className: "components-base-control__label"
          }, __('Advanced Custom Fields', 'blockshop-options')), " ", Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(SelectControl, {
...
var DevicesOptions = function DevicesOptions(props) {
  ...
  var onSelectDevice = function onSelectDevice(device) {
    var newValue = !sidetrack[device];
    delete sidetrack[device];
    var blockOptions = Object.assign(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, device, newValue), sidetrack);
    dispatch('core/block-editor').updateBlockAttributes(clientId, {
      sidetrack: blockOptions
    });
...
var LogicOptions = function LogicOptions(props) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "sidetrack-button-group-container sidetrack-button-group-logic"
...
var UserStateOptions = function UserStateOptions(props) {
  ...
  var onSelectUser = function onSelectUser(state) {
    var newValue = !sidetrack[state];
    delete sidetrack[state];
    var blockOptions = Object.assign(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, state, newValue), sidetrack);
    dispatch('core/block-editor').updateBlockAttributes(clientId, {
      sidetrack: blockOptions
    });
...
function applyExtraClass(extraProps, blockType, attributes) {
  ...
  if (typeof sidetrack !== 'undefined' && !restrictedBlocks.includes(blockType.name)) {
    if (typeof sidetrack.id !== 'undefined') {
      extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_3___default()(extraProps.className, sidetrack.id);
    }

    if (typeof sidetrack.desktop !== 'undefined' && !sidetrack.desktop) {
      extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_3___default()(extraProps.className, 'sidetrack-no-desktop');
    }

    if (typeof sidetrack.tablet !== 'undefined' && !sidetrack.tablet) {
      extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_3___default()(extraProps.className, 'sidetrack-no-tablet');
    }

    if (typeof sidetrack.mobile !== 'undefined' && !sidetrack.mobile) {
      extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_3___default()(extraProps.className, 'sidetrack-no-mobile');
    }
  }
...
addFilter('blocks.registerBlockType', 'sidetrack/custom/attributes', addAttributes);
addFilter('editor.BlockEdit', 'sidetrack/attributes', withAttributes);
addFilter('blocks.getSaveContent.extraProps', 'sidetrack/applyExtraClass', applyExtraClass);
addFilter('editor.BlockListBlock', 'sidetrack/addEditorBlockAttributes', addEditorBlockAttributes);
...
addFilter('editor.BlockEdit', 'sidetrack/block-panel', withBlockPanel);
addFilter('editor.BlockListBlock', 'sidetrack/withTextSettings', withTextSettings);
addFilter('blocks.getSaveContent.extraProps', 'sidetrack/applyTextSettings', applyTextSettings);
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function () {
  ...
  return {
    onCopy: function onCopy() {
      ...
      var notice = __('Selected block copied.', 'blockshop-options');
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SetAsFeatImageured, [{
    ...
    value: function render() {
      ...
      var label = function label() {
        return imageID === featuredImageID ? __('Remove as Featured Image', 'blockshop-options') : __('Set as Featured Image', 'blockshop-options');
      };
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function () {
  ...
  return {
    onUpdateImage: function onUpdateImage(imageID) {
      ...
      createNotice('info', __('Image Set as Featured.', 'blockshop-options'), {
        isDismissible: true,
        type: 'snackbar'
      });
    },
    onRemoveImage: function onRemoveImage() {
      ...
      createNotice('info', __('Featured Image Removed.', 'blockshop-options'), {
        isDismissible: true,
        type: 'snackbar'
      });
    }
...
var PluginBlockSettingsMenuItem = wp.editPost.PluginBlockSettingsMenuItem;
var compose = wp.compose.compose;
var restrictedBlocks = ['core/freeform', 'core/shortcode', 'core/block', 'core/template', 'sidetrack/import'];
/**
 * Render plugin
 */
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(PluginBlockSettingsMenuItem, {
        ...
        switch (tab.name) {
          ...
          default:
            return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("small", null, __('Attention: The display settings (show/hide for mobile, tablet, desktop or users) will only take effect once you are on the live page, and not while you\'re editing in Gutenberg.', 'blockshop-options')),
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(NavigatorToolbar, [{
    ...
    value: function render() {
      ...
      var navigatorToolbarButton = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(IconButton, {
        ...
        label: __('Open block navigator', 'blockshop-options'),
        onClick: function onClick() {
          return _this2.setState({
      ...
      var navigatorModal = this.state.isNavigationListOpen && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Modal, {
        title: __('Block Navigator', 'blockshop-options'),
        closeLabel: __('Close', 'blockshop-options'),
        onRequestClose: function onRequestClose() {
          _this2.setState({
            isNavigationListOpen: false
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function (select, props) {
  ...
  return {
    ...
    isDisabled: select('core/edit-post').isFeatureActive('disableSidetrackNavigatorOptions')
  };
}), withDispatch(function (dispatch) {
  return {
...
addFilter('editor.BlockEdit', 'sidetrack/media-text-link', withNavigator);
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function (select) {
  return {
    isDisabled: select('core/edit-post').isFeatureActive('disableSidetrackCoverAlignmentOptions')
  };
  ...
  return function (props) {
    ...
    if (allowedBlocks.includes(name) && verticalAlignment) {
      if (verticalAlignment === 'top') {
        customData = Object.assign(customData, {
          'data-sidetrack-is-vertically-top': 1
        });
      } else if (verticalAlignment === 'bottom') {
        customData = Object.assign(customData, {
          'data-sidetrack-is-vertically-bottom': 1
        });
      }
    }
...
addFilter('blocks.registerBlockType', 'sidetrack/cover/attributes', addAttributes);
addFilter('editor.BlockEdit', 'sidetrack/cover-vertical-alignment', withControls);
addFilter('blocks.getSaveContent.extraProps', 'sidetrack/cover/applyExtraClass', applyExtraClass);
addFilter('editor.BlockListBlock', 'sidetrack/cover/addEditorBlockAttributes', addEditorBlockAttributes);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ToolbarControls, [{
    ...
    value: function render() {
      ...
      var toolbarControls = [{
        ...
        title: __('Show media on top', 'blockshop-options'),
        ...
        title: __('Show media on bottom', 'blockshop-options'),
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(BlockControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Toolbar, {
        className: "sidetrack-media-text-card-controls",
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function (select) {
  return {
    isDisabled: select('core/edit-post').isFeatureActive('disableSidetrackMediaTextLayoutOptions')
  };
}), withSpokenMessages)(ToolbarControls));
...
addFilter('editor.BlockEdit', 'sidetrack/media-text-link', withControls);
...
addFilter('blocks.registerBlockType', 'sidetrack/media-text-link/attributes', addAttributes);
addFilter('editor.BlockEdit', 'sidetrack/media-text-link', withControls);
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function (select) {
  ...
  return {
    onConvertToStatic: function onConvertToStatic() {
      ...
      createNotice('info', __('Reusable Block converted.', 'blockshop-options'), {
        isDismissible: true,
        type: 'snackbar'
      });
    }
...
addFilter('editor.BlockEdit', 'sidetrack/reusable-block-convert', withControls);
...
addFilter('blocks.registerBlockType', 'sidetrack/transform/group', addTransforms);
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ManageAutoSave, [{
    ...
    value: function componentDidMount() {
      ...
      var prompt = '<span class="sidetrack-auto-save-disabled--label">' + __('Auto Save Disabled', 'blockshop-options') + '</span>'; //insert prompt on header
    ...
    value: function sync() {
      ...
      var prompt = document.querySelector('.sidetrack-auto-save-disabled--label'); //update autosave interval
...
var DEFAULT_FEATURE_IMAGE_LABEL = __('Featured Image', 'blockshop-options');

var DEFAULT_SET_FEATURE_IMAGE_LABEL = __('Set Featured Image', 'blockshop-options');

var DEFAULT_REMOVE_FEATURE_IMAGE_LABEL = __('Remove Image', 'blockshop-options');
...
var PostFeaturedImage = function PostFeaturedImage(_ref) {
  ...
  var instructions = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, __('To edit the featured image, you need permission to upload media.', 'blockshop-options'));
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PostFeaturedImageCheck, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "editor-post-featured-image sidetrack-post-featured-image"
    ...
    className: "sidetrack-post-featured-spinner"
...
addFilter('editor.PostFeaturedImage', 'sidetrack/post-featured-image', withDragandDropFeaturedImage);
...
function AboutGutenbergEditor(_ref) {
  ...
  var _window$sidetrackInfo = window.sidetrackInfo,
      core = _window$sidetrackInfo.core,
      editor = _window$sidetrackInfo.editor,
      plugin = _window$sidetrackInfo.plugin;
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, __('Version', 'blockshop-options'), " ", Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("strong", null, editor.version)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, editor.is_core ? sprintf(__('You are using the new block editor bundled on WordPress core %s', 'blockshop-options'), core.version) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(RawHTML, null, sprintf(__('You are using the new block editor powered by the %sGutenberg Plugin%s.', 'blockshop-options'), '<a href="https://wordpress.org/plugins/gutenberg/" target="_blank" rel="noreferrer noopener nofollow">', '</a>'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(RawHTML, null, sprintf(__(' Want to help? %sGet involved or report an issue%s.', 'blockshop-options'), '<a href="https://github.com/WordPress/gutenberg/issues" target="_blank" rel="noreferrer noopener nofollow">', '</a>'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
    className: "sidetrack-version-small"
  }, sprintf(__('Sidetrack %s', 'blockshop-options'), plugin.version)));
}
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(HelpControl, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var helpButton = document.querySelector('.sidetrack-component-help-tips');
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Dropdown, {
        ...
        renderContent: function renderContent(_ref2) {
          ...
          return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(NavigableMenu, {
            ...
            onClick: function onClick() {
              _this2.routeChange("https://www.facebook.com/groups/sidetrack/");
            }
          }, __('Sidetrack Community Help')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
        ...
        className: "components-modal--sidetrack-help-tips-buttons"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(IconButton, {
        isPrimary: true,
        isLarge: true,
        icon: "twitter",
      ...
      }, __('View All Tips and Tricks', 'blockshop-options')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Button, {
        isDefault: true,
        isLarge: true,
        onClick: function onClick() {
          _this2.nextTweet();
        }
      }, __('Next', 'blockshop-options'))) : __('Fetching...', 'blockshop-options')) : null, this.state.isAboutOpen ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_about__WEBPACK_IMPORTED_MODULE_7__["AboutGutenbergEditor"], {
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(FeaturesManagerModal, [{
    ...
    value: function render() {
      ...
      }, __('Sidetrack Settings', 'blockshop-options')), this.state.isOpen ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Modal, {
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(FeaturesManager, [{
    ...
    value: function render() {
      ...
      var getSettings = editorSettings.sidetrack;
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Fragment, null, lodash_map__WEBPACK_IMPORTED_MODULE_6___default()(getSettings, function (category) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("section", {
          ...
          className: "edit-post-sidetrack-manager-modal__checklist"
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(MarkdownFormatting, [{
    ...
    value: function render() {
      ...
      }, __('Markdown Formatting', 'blockshop-options')), this.state.isOpen ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Modal, {
      ...
      if (document.querySelector('.table-of-contents').contains(event.target) && button === 'false') {
        ...
        var checkExist = setInterval(function () {
          if (document.querySelector('.table-of-contents__popover')) {
            document.querySelector('.table-of-contents__counts').insertAdjacentHTML('beforeend', "<li class=\"table-of-contents__count table-of-contents__wordcount\">".concat(__('Reading Time', 'blockshop-options'), "<span class=\"table-of-contents__number\">").concat(estimated, " min</span></li>"));
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(AddSelectedBlockClass, [{
    ...
    value: function componentDidUpdate() {
      ...
      var regx = new RegExp('\\bsidetrack-selected--.*?\\b', 'g');
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(DisableTitle, [{
    ...
    value: function initialize() {
      ...
      if (titleBlock) {
        var isHidden = typeof postmeta !== 'undefined' && typeof postmeta._sidetrack_title_hidden !== 'undefined' ? postmeta._sidetrack_title_hidden : false;
        var bodyClass = isHidden ? 'sidetrack-title-hidden' : 'sidetrack-title-visible'; //remove existing class
...
var name = 'sidetrack/abbreviation';
...
addFilter('blocks.registerBlockType', 'sidetrack/alignment/attributes', addAttributes);
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(AlignmentControl, [{
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(BlockControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Toolbar, {
        className: "sidetrack-components-alignment-toolbar"
...
var _wp$compose = wp.compose,
    compose = _wp$compose.compose,
    ifCondition = _wp$compose.ifCondition;
var name = 'sidetrack/background';

var title = __('Highlight Color', 'blockshop-options');
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Edit, [{
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(BlockControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Toolbar, {
        className: "sidetrack-components-toolbar"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(IconButton, {
        className: classnames__WEBPACK_IMPORTED_MODULE_7___default()('components-button components-icon-button components-sidetrack-toolbar__control components-toolbar__control components-sidetrack-background-format', {
          'is-active': isActive
        }),
        ...
        onClickOutside: function onClickOutside(_onClickOutside) {
          if (!_onClickOutside.target.classList.contains('components-sidetrack-background-format') && !document.querySelector('.components-sidetrack-background-format').contains(_onClickOutside.target) && (!document.querySelector('.components-color-palette__picker') || document.querySelector('.components-color-palette__picker') && !document.querySelector('.components-color-palette__picker').contains(_onClickOutside.target))) {
            _this2.setState({
              isOpen: !isOpen
            });
          }
        ...
        onChange: function onChange(color) {
          if (color) {
            ...
            if (typeof window.sidetrackInfo !== 'undefined' && window.sidetrackInfo.supports.color_palette) {
...
var name = 'sidetrack/clear-formatting';
var clear = {
  name: name,
  title: __('Clear Formatting', 'blockshop-options'),
  tagName: 'span',
...
var isDisabled = select('core/edit-post').isFeatureActive('disableSidetrackLinkFormats');
...
wp.domReady(registerSidetrackFormats);
...
var name = 'sidetrack/link';

var title = __('Add Link', 'blockshop-options');
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Edit, [{
    ...
    value: function onRemoveFormat() {
      ...
      var newValue = value;
      Object(lodash__WEBPACK_IMPORTED_MODULE_8__["map"])(['core/link', 'sidetrack/link'], function (linkFormat) {
...
function LinkEditor(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("form", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    icon: "editor-break",
    label: __('Apply', 'blockshop-options'),
    type: "submit"
  }));
}
...
function LinkViewer(_ref2) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    icon: "edit",
    label: __('Edit', 'blockshop-options'),
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(URLInput, [{
    ...
    value: function updateSuggestions(value) {
      ...
      request.then(function (posts) {
        ...
        if (posts.length) {
          ...
          _this4.props.debouncedSpeak(__('No results.', 'blockshop-options'), 'assertive');
        }
      }).catch(function () {
        if (_this4.suggestionsRequest === request) {
          _this4.setState({
        ...
        case TAB:
          {
            if (this.state.selectedSuggestion !== null) {
              ...
              this.props.speak(__('Link selected.', 'blockshop-options'));
            }
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        ...
        autoFocus: autoFocus,
        type: "text",
        "aria-label": __('URL', 'blockshop-options'),
        required: true,
        value: value,
        onChange: this.onChange,
        onInput: stopEventPropagation,
        placeholder: __('Paste URL or type to search', 'blockshop-options'),
        onKeyDown: this.onKeyDown,
        role: "combobox",
        ...
        }, decodeEntities(post.title) || __('(no title)', 'blockshop-options'));
      }))));
...
function createLinkFormat(_ref) {
  ...
  if (opensInNewWindow) {
    ...
    var label = sprintf(__('%s (opens in a new tab)', 'blockshop-options'), text);
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function () {
  return {
    isDisabled: select('core/edit-post').isFeatureActive('disableSidetrackNonbreakingSpaceFormats')
  };
}), ifCondition(function (props) {
  return !props.isDisabled;
}), withSpokenMessages)(Edit));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SubscriptControl, [{
    ...
    value: function render() {
      ...
      var onToggle = function onToggle() {
        ...
        var record = removeFormat(value, 'sidetrack/superscript');
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function () {
  return {
    isDisabled: select('core/edit-post').isFeatureActive('disableSidetrackSubscriptFormats')
  };
}), ifCondition(function (props) {
  return !props.isDisabled;
}))(SubscriptControl));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SuperscriptControl, [{
    ...
    value: function render() {
      ...
      var onToggle = function onToggle() {
        ...
        var record = removeFormat(value, 'sidetrack/subscript');
        onChange(toggleFormat(record, {
          type: name
        }));
      };
...
var name = 'sidetrack/superscript';
var superscript = {
  name: name,
  title: __('Superscript', 'blockshop-options'),
  tagName: 'sup',
...
var _wp$compose = wp.compose,
    compose = _wp$compose.compose,
    ifCondition = _wp$compose.ifCondition;
var name = 'sidetrack/color';

var title = __('Text Color', 'blockshop-options');
...
var underline = {
  ...
  edit: function edit(_ref) {
    var isActive = _ref.isActive,
        value = _ref.value,
        onChange = _ref.onChange;
    var isDisabled = select('core/edit-post').isFeatureActive('disableSidetrackUnderlineFormats');
    var formatTypes = select('core/rich-text').getFormatTypes();
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(TransformControls, [{
    ...
    value: function focus() {
      if (this.nameInput.current !== null) {
        var tabbables = _focus.tabbable.find(document.querySelector('.components-modal--sidetrack-transform-empty'));
    ...
    value: function render() {
      ...
      if (!isPrompted) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Modal, {
        ...
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("p", null, __('Do you want to automatically transform four(4) consecutive empty paragraphs into Spacer Block?', 'blockshop-options')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Button, {
          isPrimary: true,
          isLarge: true,
          onClick: function onClick() {
            onToggle(0);
          ...
          ref: this.nameInput
        }, __('Yes Enable', 'blockshop-options')), "\xA0", Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Button, {
          isDefault: true,
          isLarge: true,
          onClick: function onClick() {
            return closeModal();
          }
        }, __('No, Thanks', 'blockshop-options')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("p", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("small", null, __('This prompt will only be shown once and will remember your preference. Thanks!', 'blockshop-options')))));
      }
